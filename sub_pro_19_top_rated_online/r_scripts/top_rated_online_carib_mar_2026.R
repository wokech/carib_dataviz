#Most Reviewed Places in every Caribbean country (March 2026)
...
# Import data
carib_top_rated_mar_2026 <- read_excel("sub_pro_19_top_rated_online/datasets/top_rated_online_carib_mar_2026.xlsx", sheet = 1)

carib_top_rated_mar_2026_clean <- carib_top_rated_mar_2026 %>%
  clean_names()

str(carib_top_rated_mar_2026_clean)

carib_top_rated_mar_2026_clean <- carib_top_rated_mar_2026_clean %>%
  mutate(
...
p <- ggplot(carib_top_rated_mar_2026_clean, aes(x = number_of_reviews, y = reorder(country, number_of_reviews))) +
  # Main data segments
  geom_segment(
...
ggsave("sub_pro_19_top_rated_online/images/top_rated_online_carib_mar_2026.png", width = 12, height = 12, dpi = 300)
